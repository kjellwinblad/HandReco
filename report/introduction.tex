...
Recognition of handwritten text has been a popular research area for decades because it can be used in so many different applications. % I'm not sure if a source is necessary for that statment?
...
Because handwritten recognition is such a well-researched area there is a wealth of literature available.% I'm not sure if a source is necessary for that statment?
