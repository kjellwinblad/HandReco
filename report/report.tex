...
%1. Top down feature extraction to improve performance.
%2. Add more training data.
%3. Consider non pre-segmented.
%4. Better scaling that doesn't thicken lines, or second step to remove unnecessary pixels.
%5. More advanced feature extraction, use different representation that makes it easier to extend with more features.
