...
In this section the results for the test of the classifiers described in section~\ref{sec:method} will be presented. The results are discussed in more detail in section~\ref{sec:discussion}. Ideas for how to improve the system to get better results are presented in section~\ref{sec:future_work}.
